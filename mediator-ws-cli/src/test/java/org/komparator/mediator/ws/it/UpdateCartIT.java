...
public class UpdateCartIT extends BaseIT {
	...
	@Test
	public void addSleepAddAgain() throws InvalidCartId_Exception, InvalidItemId_Exception, 
	InvalidQuantity_Exception, NotEnoughItems_Exception, InterruptedException {
		...
		Thread.sleep(10000);
		System.out.printf("%s woke up!%n", UpdateCartIT.class);
		System.out.println("Buying items fift round");
	...
	@Test
	public void addWithoutSleeping() throws InvalidCartId_Exception, InvalidItemId_Exception, 
	InvalidQuantity_Exception, NotEnoughItems_Exception, InterruptedException {
		System.out.println("Buying items first round");
